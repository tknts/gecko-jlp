...
about-debugging-this-firefox-runtime-name = この { -brand-shorter-name } について
...
about-debugging-sidebar-runtime-item-waiting-for-browser = ブラウザを待機しています…
...
about-debugging-browser-version-too-recent = 接続したブラウザ ({ $runtimeVersion }, ビルド ID { $runtimeID }) が、実行中の { -brand-shorter-name } ({ $localVersion }, ビルド ID { $localID }) よりも新しいです。この組み合わせはサポートされてないため、開発ツールでエラーが発生する可能性があります。Firefox を更新してください。<a>トラブルシューティング</a>
...
about-debugging-extension-backgroundscript-status-running = 動作中

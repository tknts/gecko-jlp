...
devtools-tooltip-learn-more = さらに詳しく
...
inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = <strong>display:grid</strong>、<strong>display:flex</strong>、または <strong>columns:2</strong> のいずれかを追加してみてください。

inactive-css-not-grid-or-flex-container-or-multicol-container-fix-1 = <strong>display:grid</strong>、<strong>display:flex</strong>、または <strong>columns:2</strong> のいずれかを追加してみてください。

inactive-css-not-multicol-container-fix-1 = <strong>column-count</strong> または <strong>column-width</strong> のいずれかを追加してみてください。

inactive-css-column-span-fix-1 = 先祖要素のいずれかに <strong>column-count</strong> または <strong>column-width</strong> を追加してみてください。

inactive-css-not-grid-or-flex-or-absolutely-positioned-item-fix-1 = この要素に <strong>position:absolute</strong> を追加するか、親要素に <strong>display:grid</strong>、<strong>display:flex</strong>、<strong>display:inline-grid</strong>、または <strong>display:inline-flex</strong> を追加してみてください。

inactive-css-not-grid-or-absolutely-positioned-item-fix-1 = 要素に <strong>position:absolute</strong> を追加するか、親要素に <strong>display:grid</strong> または <strong>display:inline-grid</strong> を追加してみてください。

inactive-css-not-absolutely-positioned-item-fix-1 = 要素に <strong>position:absolute</strong> を追加してみてください。

inactive-css-no-default-anchor-fix-1 = 有効なアンカー名を持つ <strong>position-anchor</strong> を追加してみてください。{ learn-more }

inactive-css-not-grid-or-flex-item-fix-4 = 要素の親要素に <strong>display:grid</strong>、<strong>display:flex</strong>、<strong>display:inline-grid</strong>、または <strong>display:inline-flex</strong> を追加してみてください。 

inactive-css-not-grid-item-fix-3 = 親要素に <strong>display:grid</strong> または <strong>display:inline-grid</strong> を追加してみてください。

inactive-css-not-grid-container-fix-1 = <strong>display:grid</strong> または <strong>display:inline-grid</strong> を追加してみてください。

inactive-css-not-flex-item-fix-3 = 親要素に <strong>display:flex</strong> または <strong>display:inline-flex</strong> を追加してみてください。
...
inactive-css-non-replaced-inline-or-table-column-or-column-group-fix = <strong>display:inline-block</strong> を追加してみてください。

inactive-css-not-display-block-on-floated-fix-1 = <strong>float</strong> を削除するか、<strong>display:block</strong> を追加してみてください。

inactive-css-only-non-grid-or-flex-item-fix-1 = この要素の親要素の <strong>display</strong> の値を <strong>flex</strong>、<strong>grid</strong>、<strong>inline-flex</strong>、<strong>inline-grid</strong> 以外に変更するか、<strong>float</strong> を削除してみてください。

inactive-css-not-block-fix-1 = <strong>display:block</strong> または <strong>float:left</strong> などのプロパティを追加してみてください。

inactive-css-not-block-container-fix-1 = <strong>display:block</strong>、<strong>display:inline-block</strong>、または <strong>display:flow-root</strong> を追加してみてください。{ learn-more }
...
inactive-css-not-floated-fix-1 = <strong>float</strong> プロパティを <strong>none</strong> 以外の値で追加してみてください。

inactive-css-position-property-on-unpositioned-box-fix-1 = <strong>position</strong> プロパティを <strong>static</strong> 以外の値に設定してみてください。

inactive-css-only-replaced-elements-fix-1 = プロパティを置き換え要素に追加していることを確認してください。

inactive-text-overflow-when-no-overflow-fix-1 = <strong>overflow:hidden</strong> を追加してみてください。

inactive-css-no-size-containment-fix-1 = <strong>display</strong> プロパティを <strong>none</strong>、<strong>contents</strong>、<strong>table</strong>、<strong>inline-table</strong> 以外の値に設定し、table または ruby セグメント内にないことを確認してください。

inactive-css-not-for-internal-table-elements-fix-1 = <strong>display</strong> プロパティを <strong>table-cell</strong>、<strong>table-column</strong>、<strong>table-row</strong>、<strong>table-column-group</strong>、<strong>table-row-group</strong>、または <strong>table-footer-group</strong> 以外の値に設定してみてください。

inactive-css-not-for-internal-table-elements-except-table-cells-fix-1 = <strong>display</strong> プロパティを <strong>table-column</strong>、<strong>table-row</strong>、<strong>table-column-group</strong>、<strong>table-row-group</strong>、または <strong>table-footer-group</strong> 以外の値に設定してみてください。
...
inactive-css-border-image-fix-1 = 親の table 要素で、プロパティを削除するか、<strong>border-collapse</strong> の値を <strong>collapse</strong> 以外の値に変更してください。

inactive-css-resize-fix-1 = <strong>overflow</strong> の値を <strong>visible</strong> 以外の値に設定するか、それをサポートする置き換え要素を対象にしてみてください。
...
inactive-css-text-wrap-balance-fragmented-fix-1 = 段組みを削除するか、<strong>page-break-inside:avoid</strong> を使用するなどして、要素のコンテンツが分割されないようにしてください。 

inactive-css-no-principal-box-fix-1 = <strong>block</strong>、<strong>inline-block</strong>、<strong>flex</strong>、または <strong>grid</strong> など、プリンシパルボックスを作成する <strong>display</strong> の値を追加してみてください。

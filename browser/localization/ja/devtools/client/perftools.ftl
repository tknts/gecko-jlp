...
perftools-presets-networking-with-logs-label = ログ付きのネットワーク
perftools-presets-networking-with-logs-description = ネットワークログを含む、{ -brand-shorter-name } 内のネットワークバグを調査するためのプリセット。これらのログには、アクセスした URL などの機密情報が含まれる場合があります。

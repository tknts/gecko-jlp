...
get-proxy-extension-link = 拡張機能を入手する
...
get-vpn-link = { -mozilla-vpn-brand-name } を入手
...
vpn-header-content-subscribed = { -mozilla-vpn-brand-name } を使用すると、すべてのトラフィックが暗号化され、最大 5 台のデバイスで接続元を隠せます。 サブスクリプションを最大限に活用する — <a data-l10n-name="vpn-google-playstore-link">Google Play ストア</a> または <a data-l10n-name="vpn-app-store-link">Apple App Store</a> から追加します。
...
vpn-banner-link = { -mozilla-vpn-brand-name } を入手

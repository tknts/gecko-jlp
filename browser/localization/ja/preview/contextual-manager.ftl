...
contextual-manager-command-copy = コピー
contextual-manager-command-reveal = 表示
contextual-manager-command-conceal = 隠す
contextual-manager-command-toggle = Toggle
contextual-manager-command-open = 開く
contextual-manager-command-delete = Remove record
contextual-manager-command-edit = 編集
contextual-manager-command-save = 保存
contextual-manager-command-cancel = キャンセル

## Passwords

contextual-manager-passwords-section-label = パスワード
contextual-manager-passwords-disabled = パスワードは無効です

contextual-manager-passwords-expand-section-tooltip = パスワードを表示します
contextual-manager-passwords-collapse-section-tooltip = パスワードを隠します
...
contextual-manager-passwords-command-sort-name = 名前順で並び替え (A-Z)
# This message can be seen when sorting logins by breached or vulnerable alerts.
contextual-manager-passwords-command-sort-alerts = 警告順で並び替え
...
contextual-manager-payments-command-create = 決済方法を追加

contextual-manager-payments-section-label = 決済方法
contextual-manager-payments-disabled = 決済方法が無効になっています

contextual-manager-payments-expand-section-tooltip = 決済方法を表示します
contextual-manager-payments-collapse-section-tooltip = 決済方法を隠します
...
contextual-manager-card-number-label = カード番号
contextual-manager-card-expiration-label = 有効期限
contextual-manager-card-holder-label = カードの名義

## Addresses

contextual-manager-addresses-command-create = 住所を追加

contextual-manager-addresses-section-label = 住所
contextual-manager-addresses-disabled = Addresses are disabled

contextual-manager-addresses-expand-section-tooltip = 住所を表示します
contextual-manager-addresses-collapse-section-tooltip = 住所を隠します
...
contextual-manager-address-name-label = 名前
contextual-manager-address-phone-label = 電話番号
contextual-manager-address-email-label = メールアドレス

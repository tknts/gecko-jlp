...
leave-ion-consent-bullet-thanks = ご参加ありがとうございました。
...
ion-works-title = 使い方:
ion-works-bullet-get-started-title = はじめに。
ion-works-bullet-get-started-content = {ion-enrollment-button} ボタンを選択します。次にプライバシーに関する告知を確認して同意した後、いくつかの人口統計に関する質問 (任意) に答えてください。{ -ion-brand-short-name } は現在 19 歳以上の米国の参加者にのみ開放されていることに注意してください。
ion-works-bullet-enroll-title = Enroll in studies.
ion-works-bullet-enroll-content = { -vendor-short-name } および { -ion-brand-short-name } の調査パートナーが実施する調査とデータを共有してください。登録する前に、研究の目標、収集するデータ、研究チームについて知る必要があります。
ion-works-bullet-control-title = コントロールしてください。
ion-works-bullet-control-content = { -brand-product-name } のツールバーに{ -ion-brand-short-name } のアイコンが表示されます。いつでもアイコンを選択すれば、設定の変更や、研究への登録、また研究や { -ion-brand-short-name } プログラムを終了する事ができます。

ion-your-data-title = あなたのデータ: データが重要な理由と保護の方法
ion-your-data-summary ={ -ion-brand-short-name } は、より良いインターネットのためにデータを活用します。 私たちの目標は、インターネットの使用、オンライン プライバシー、アルゴリズムによる偏見、差別、誤報などのトピックをよりよく理解することです。 これは、技術環境を根本的に変え、より多くのパワーとコントロールをユーザーに戻す新製品につながる可能性があります.
...
ion-your-data-bullet-leave = { -ion-brand-short-name } プログラムはいつでも終了できます。終了するとデータの収集が停止されます。
...
ion-us-only = 申し訳ありません。{ -ion-brand-short-name } は現在米国からのみ参加できます。
...
ion-enroll-who-we-disclose-bullet-gcp = <strong>Google Cloud Platform (GCP):</strong> 私たちはクラウドストレージサービスとして GCP を使用しています。Mozilla は GCP と契約し、私たちが承認した方法でデータを処理することを義務付けています。
...
ion-enroll-data-management = データの管理:
ion-enroll-data-management-learn-more = { -ion-brand-short-name } と個々の研究データの管理について詳しくは <a data-l10n-name="privacy-policy">こちら</a> をご覧ください。当社のプライバシー慣行に関して他に質問がある場合は <a data-l10n-name="compliance-email">compliance@mozilla.com</a> までご連絡ください。

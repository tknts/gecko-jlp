...
translations-settings-back-button =
    .aria-label = 設定に戻ります
translations-settings-header = その他の翻訳設定

translations-settings-description = 言語とサイト翻訳の設定を行い、オフライン時の翻訳用にダウンロードした言語を管理します。
...
translations-settings-download-language = 言語

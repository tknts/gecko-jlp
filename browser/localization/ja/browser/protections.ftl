...
protections-vpn-title = ブラウザーを超えたプライバシー保護
protections-vpn-header-content = { -mozilla-vpn-brand-name } でデバイス全体を保護しましょう。1 タップですべてのトラフィックを暗号化し、位置情報を隠します。
protections-get-vpn-link = { -mozilla-vpn-brand-name } を入手

protections-vpn-title-subscribed = VPN: 登録済み
# Variables
#   $count (number): Number of devices
protections-vpn-header-content-subscribed =
    { $count ->
       *[other] { -mozilla-vpn-brand-name } を使用すると、最大 { $count } 台のデバイスですべてのトラフィックが暗号化され、位置情報が隠されます。サブスクリプションを最大限に活用するために、<a data-l10n-name="playstore-link">Google Play ストア</a> または <a data-l10n-name="appstore-link">Apple App Store</a> から追加してください。
    }

protections-vpn-banner-header = ブラウザーの枠を超える保護機能
protections-vpn-banner-content = リスクフリーで { -mozilla-vpn-brand-name } をお試しください。TechRadar が “その速度、シンプルさ、そして月額料金の安さは、一見の価値がある” と評価した理由を実感してください。
protections-vpn-banner-link = { -mozilla-vpn-brand-name } を入手

...
preonboarding-privacy-notice-header-button-title = プライバシー通知をお読みください
...
preonboarding-checklist-interaction-data-label = 技術データとインタラクションデータ (操作情報) を { -vendor-short-name } に送信します
preonboarding-checklist-interaction-data-description = お使いのデバイス、ハードウェア構成、そして { -brand-product-name } の使用状況に関するデータは、すべてのユーザーにとって機能、パフォーマンス、安定性を向上させるのに役立ちます。
preonboarding-checklist-crash-reports-label = クラッシュレポートを自動的に送信
preonboarding-checklist-crash-reports-description = クラッシュレポートにより、ブラウザーの問題を診断し修正することができます。レポートには、個人情報や機密データが含まれる場合があります。

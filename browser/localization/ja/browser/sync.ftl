...
fxa-menu-send-to-mobile-sign-in = サインインしてタブを送信
...
fxa-menu-sign-in-promo-heading = サインインして同期
fxa-menu-sign-in-promo-message = どこからでもデータにアクセスできます
...
fxa-menu-signed-out-message-login-failed = サインアウトしています

...
customkeys-dev-debugger = デバッガー (JavaScript デバッガー)
customkeys-dev-network = ネットワーク モニター
customkeys-dev-style = スタイル エディター
customkeys-dev-performance = パフォーマンス
customkeys-dev-storage = ストレージ インスペクター
...
customkeys-nav-select-tab-1 = タブ 1 へ移動
customkeys-nav-select-tab-2 = タブ 2 へ移動
customkeys-nav-select-tab-3 = タブ 3 へ移動
customkeys-nav-select-tab-4 = タブ 4 へ移動
customkeys-nav-select-tab-5 = タブ 5 へ移動
customkeys-nav-select-tab-6 = タブ 6 へ移動

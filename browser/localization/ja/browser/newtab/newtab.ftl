...
newtab-weather-change-location-search-use-current =
    .label = 現在地を使用する
newtab-weather-menu-weather-display = 天気の表示設定
newtab-weather-todays-forecast = 今日の予報
...
newtab-section-follow-topic =
    .aria-label = { $topic } をフォローする
# Variables:
#   $topic (string) - Name of topic that user is unfollowing
newtab-section-unfollow-topic =
    .aria-label = { $topic } のフォローを解除する
# Variables:
#   $topic (string) - Name of topic that user is blocking
newtab-section-block-topic =
    .aria-label = { $topic } をブロックする
# Variables:
#   $topic (string) - Name of topic that user is unblocking
newtab-section-unblock-topic =
    .aria-label = { $topic } のブロックを解除する
...
newtab-widget-section-show-more =
    .label = もっと多くのウィジェットを表示
# Button shown when the widgets row is expanded to multiple rows,
# allowing users to collapse it back to one row.
newtab-widget-section-show-less =
    .label = 表示するウィジェットを減らす
...
newtab-widget-lists-celebration-headline = お疲れ様でした
newtab-widget-lists-celebration-subhead = すべて完了しました
...
newtab-widget-timer-celebration-heading-focus = お疲れ様でした
# Heading shown inside the Timer widget after a break session ends.
newtab-widget-timer-celebration-heading-break = 休憩時間が終了しました
# Message shown inside the Timer widget after a focus session ends.
newtab-widget-timer-celebration-message-focus = 休憩しませんか？
...
newtab-widget-message-focus-forecasts-title = タスクや天気予報などの一元管理
newtab-widget-message-focus-forecasts-body = { -brand-product-name } ウィジェットで日常をスムーズに進めましょう。天気予報の確認、タスクの維持、世界中の時間の追跡などをまとめて行えます。
...
newtab-activation-window-message-customization-focus-header = このスペースを自分好みに
newtab-activation-window-message-customization-focus-message = 新しい壁紙を選んだり、お気に入りのサイトへのショートカットを追加したり、興味のある記事をチェックしたりできます。
...
newtab-clock-widget-edit-item-with-nickname =
    .aria-label = { $city }、ニックネーム: { $nickname }
...
newtab-privacy-etp-off-faster-browsing = より高速なブラウジング。より少ないトラッカー。
newtab-privacy-etp-off-turn-on-tracking = ブロックを開始するには、設定でトラッキング防止機能を有効にしてください。
...
newtab-picture-set-wallpaper =
    .label = 壁紙に設定
    .title = 壁紙に設定します
    .aria-label = 今日の写真を壁紙に設定します

# Context menu item that opens the New Tab customization panel.
newtab-picture-menu-manage-wallpaper = 壁紙の管理

# Context menu item that hides today’s picture, replacing it with an existing
# wallpaper.
newtab-picture-menu-hide-photo = 今日の写真を非表示にする
...
newtab-picture-show-button =
    .title = 今日の写真を表示します
    .aria-label = 今日の写真を表示します

# Shown when there is no new picture to display yet.
newtab-picture-check-back = 明日また新しい写真を確認してください

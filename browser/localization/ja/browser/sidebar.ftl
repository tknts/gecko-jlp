...
sidebar-opentabs-preview-heading = 最近のタブ
...
sidebar-bookmarks-folder-menu = ブックマーク メニュー
sidebar-bookmarks-folder-toolbar = ブックマーク ツールバー
sidebar-bookmarks-folder-other = その他のブックマーク

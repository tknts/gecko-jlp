...
migration-safari-password-import-post-sequoia-step1 = Mac で <a data-l10n-name="macos-passwords-app">パスワードアプリ</a> を開く
migration-safari-password-import-post-sequoia-step2 = 画面上部のメニューバーから、[ファイル] > [すべてのパスワードをファイルに書き出す…] を選択する
migration-safari-password-import-post-sequoia-step3 = ファイルを保存する
migration-safari-password-import-post-sequoia-step4 = 保存したファイルを選択する
...
migration-chrome-windows-password-import-step4 = ここに戻り、“ファイルを選択” をクリックしてインポートを完了してください。

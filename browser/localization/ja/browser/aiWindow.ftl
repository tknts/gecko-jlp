...
toolbar-switcher-customizable-label =
    .label = { -smart-window-brand-name } の切り替え
...
smartbar-placeholder-hint-1 = @ を入力して最近のタブをメンション…
smartbar-placeholder-hint-2 = 何でも質問してください…
smartbar-placeholder-hint-3 = ウェブアドレスを入力…
smartbar-placeholder-hint-4 = ウェブを検索…
...
firefoxview-chats-empty-description = { -smart-window-brand-name } を使用すると、こちらにチャットが保存されます。
...
smart-window-default-promo-heading = { -smart-window-brand-name } をデフォルトにしますか？
smart-window-default-promo-message = 毎回 { -brand-short-name } を { -smart-window-brand-name } で開くようになります。
...
aiwindow-ai-chat-grid-view-controls =
    .aria-label = 表示レイアウトを切り替え
aiwindow-ai-chat-grid-list-view =
    .aria-label = モードを切り替え: リスト表示
    .tooltiptext = リスト表示

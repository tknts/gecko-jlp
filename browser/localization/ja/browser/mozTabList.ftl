...
mztabrow-just-now-timestamp = たった今
...
mztabrow-delete = 削除
    .accesskey = D
mztabrow-forget-about-this-site = このサイトの事を忘れる…
    .accesskey = F
mztabrow-open-in-window = 新しいウィンドウで開く
    .accesskey = N
mztabrow-open-in-private-window = 新しいプライベート ウィンドウで開く
    .accesskey = P
# “Bookmark” is a verb, as in "Bookmark this page" (add to bookmarks).
mztabrow-add-bookmark = ブックマーク…
    .accesskey = B
mztabrow-save-to-pocket = { -pocket-brand-name } へ保存
    .accesskey = o

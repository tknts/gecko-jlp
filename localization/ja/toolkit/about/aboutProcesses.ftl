...
about-processes-web-isolated-property-with-coop-coep = オリジン間分離済み
...
about-processes-preloaded-tab = 予め読み込まれた新しいタブ
...
about-processes-utility-actor-hw-inference = ハードウェア アクセラレーション インターフェイス

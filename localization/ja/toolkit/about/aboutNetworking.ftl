...
about-networking-auto-refresh = 3秒ごとに自動的に更新する
about-networking-hostname = ホストの名前
...
about-networking-dns-https-rr-lookup-table-column = HTTP リリースレコード
about-networking-rcwn = RCWN の統計
about-networking-rcwn-status = RCWN の状態
about-networking-rcwn-cache-won-count = キャッシュの使用回数
about-networking-rcwn-net-won-count = ネットワークの使用回数
about-networking-total-network-requests = ネットワーク リクエストの合計回数

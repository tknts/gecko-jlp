...
installed-plugins-label = インストールされているプラグイン
no-plugins-are-installed-label = インストールされているプラグインはありません

deprecation-description2 =
    .message = 何か入れ忘れていますか? 一部のプラグインはサポートされなくなりました。
...
plugins-gmp-privacy-info = 個人情報の扱いについて

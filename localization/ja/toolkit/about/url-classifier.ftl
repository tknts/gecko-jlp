...
url-classifier-debug-module-btn = ログモジュールをセット
url-classifier-debug-file-btn = ログファイルをセット
url-classifier-debug-js-log-chk = JS Log をセット
url-classifier-debug-sb-modules = セーフブラウジング中のログモジュール
url-classifier-debug-modules = 現在のログモジュール
url-classifier-debug-sbjs-modules = セーフブラウジング中の JS Log
